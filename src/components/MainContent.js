...
const MainContent = () => {
  ...
  <div id="leviPocetni">
    <p id="naslov">
      Govorne tehnologije <span className="highlighted"><br />AlfaNum.<br /></span>
    </p>
    <p id="podnaslov">
      <br />
      Kompanija sa iskustvom od preko 20 godina koja se bavi govornim tehnologijama za srpski i srodne jezike, bazira se na AI i dugogodišnjem iskustvu našeg tima.
      Nudimo najkvalitetnija rešenja za sintezu i prepoznavanje govora u domenima medicine, prava i za opštu namenu.
    </p>
  </div>
  ...
  <div className="naslovi" id="naslovPartner">
    ...
    <p>
      Sarađujemo sa malim i velikim preduzećima u Srbiji i šire
      i zajedno činimo <br /> govorne tehnologije dostupne svima.
    </p>
  </div>
